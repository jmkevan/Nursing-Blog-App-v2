...
/**
 Base class for all NursingBlogAppv2 views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the NursingBlogAppv2 view hierarchy (such as wrapped iOS UIViews) was touched.
