...
/**
 The base class for all NursingBlogAppv2 modules
 */
...
/**
 NursingBlogAppv2 Platform calls this method on startup.
 */
-(void)startup;

/**
 NursingBlogAppv2 Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 NursingBlogAppv2 Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 NursingBlogAppv2 Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 NursingBlogAppv2 Platform calls this method on resume.
 @param sender The sender of the event.
 */
