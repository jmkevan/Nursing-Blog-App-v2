...
@interface NursingBlogAppv2Object : KrollCoverageObject {
#else
@interface NursingBlogAppv2Object : KrollObject {
#endif
@private
...
extern NSString * NursingBlogAppv2$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	NursingBlogAppv2Object *_nursingblogappv2;
    KrollObject* console;
	BOOL shutdown;
