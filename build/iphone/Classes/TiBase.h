...
// in simulator we redefine to format for NursingBlogAppv2 Developer console
...
{\
	NSString * exceptionName = [@"org.nursingblogappv2." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.nursingblogappv2";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UINursingBlogAppv2NativeItemNone = -1, 
	UINursingBlogAppv2NativeItemSpinner = -2,
	UINursingBlogAppv2NativeItemProgressBar = -3,
	
	UINursingBlogAppv2NativeItemSlider = -4,
	UINursingBlogAppv2NativeItemSwitch = -5,
	UINursingBlogAppv2NativeItemMultiButton = -6,
	UINursingBlogAppv2NativeItemSegmented = -7,
	
	UINursingBlogAppv2NativeItemTextView = -8,
	UINursingBlogAppv2NativeItemTextField = -9,
	UINursingBlogAppv2NativeItemSearchBar = -10,
	
	UINursingBlogAppv2NativeItemPicker = -11,
	UINursingBlogAppv2NativeItemDatePicker = -12,
	
	UINursingBlogAppv2NativeItemInfoLight = -13,
	UINursingBlogAppv2NativeItemInfoDark = -14,
	
	UINursingBlogAppv2NativeItemDisclosure = -15,
	
	UINursingBlogAppv2NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all NursingBlogAppv2 instances of
