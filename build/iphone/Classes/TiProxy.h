...
//Rare exceptions to indicate a bug in the _nursingblogappv2 code (Eg, function that a subclass should have implemented)
...
/**
 The base class for NursingBlogAppv2 proxies.
 */
