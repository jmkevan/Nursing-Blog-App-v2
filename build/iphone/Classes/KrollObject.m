 ...
 * Copyright (c) 2009-2011 by NursingBlogAppv2, Inc. All Rights Reserved.
...
//@interface NursingBlogAppv2Object : NSObject
//@end

@interface NursingBlogAppv2Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[NursingBlogAppv2Object class]])
		{
			for (NSString *key in [[(NursingBlogAppv2Object*)o modules] allKeys])
			{
